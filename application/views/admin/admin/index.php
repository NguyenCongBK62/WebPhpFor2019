...
<div class="col-sm-9 col-sm-offset-3 col-lg-10 col-lg-offset-2 main">
	...
	<div class="row">
            ...
            <a href="https://shielded-sierra-44382.herokuapp.com/admin/admin/add" class="btn btn-success">
                            ...
                            <tbody>
                          	...
                          	<?php foreach($list as $row):?>
                            	<p><tr>
                                    ...
                                    <td class="form-group">
                                        <a href="<?php echo "https://shielded-sierra-44382.herokuapp.com/admin/admin/edit/".$row->id;?>" class="btn btn-primary"><i class="glyphicon glyphicon-pencil"></i></a>
                                        <a href="<?php echo "https://shielded-sierra-44382.herokuapp.com/admin/admin/delete/".$row->id;?>" class="btn btn-danger"><i class="glyphicon glyphicon-remove"></i></a>
                                    </td>
                                </tr></p>
                            <?php endforeach; ?>
                            </tbody>
